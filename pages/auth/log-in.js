...
import imgPath from "../../assets/images/login_image.png";
          ...
          <div className="flex flex-col items-center justify-center h-full">
            {Object.values(providers).map((provider) => (
              <div key={provider.name}>
                ...
                <div>
                  <button className="bg-orange-400 shadow-md rounded-xl text-sm text-white px-20 py-3 w-full mb-7">
                    Sign up
                  </button>
                </div>
                ...
                <div className="flex gap-1 text-sm font-medium justify-center mb-10">
                    ...
                    <button className="text-red-600 hover:underline" onClick={()=> router.push('/auth/sign-up')}>Sign up</button>
                </div>
